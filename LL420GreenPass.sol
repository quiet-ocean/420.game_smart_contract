...
contract LL420GreenPass is ERC1155Burnable, ReentrancyGuard, Ownable {
    ...
    function claim(bytes32[] calldata merkleProof, uint256 _qty) external payable nonReentrant onlyStarted {
        require(_qty > 0 && _qty <= MAX_PASSES, "LL420GreenPass: Can't mint 0 or more than MAX_PASSES");
        require(msg.value >= GREEN_PASS_FEE.mul(_qty), "LL420GreenPass: Not enough fee");
